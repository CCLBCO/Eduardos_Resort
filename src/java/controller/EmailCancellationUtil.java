 ...
 * @author Gil Cruzada
 */
public class EmailCancellationUtil {
    ...
    private static Message prepareMessage(Session session, String sA, String rec, String content) throws MessagingException{
        ...
        try {
            ...
            msg.setSubject("Eduardo's Resort Booking Cancellation");
            ...
            Logger.getLogger(EmailCancellationUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;        
    }
