 ...
 * @author Gil Cruzada
 */
public class EmailForgotPasswordUtil {
    ...
    private static Message prepareMessage(Session session, String sA, String rec, String content) throws MessagingException{
        ...
        try {
            ...
            msg.setSubject("Eduardo's Resort OTP");
            ...
            Logger.getLogger(EmailForgotPasswordUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;        
    }
