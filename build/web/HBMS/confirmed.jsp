...
-->
                           ...
                           <div class="row justify-content-between mt-3 w-100 ml-0 centeritems">
                                <div class="row col-sm-12 col-lg-7 pt-2 filterflex1">
                                    ...
                                    <form class="w-100 filterflex1" method="POST" id="EditRecordsServlet" action="<%= request.getContextPath()%>/EditRecordsServlet"></form>
                                        ...
                                        <button onclick="toggleMoveWarning()" class="col-sm-12 col-lg-4 mt-sm-2 mt-lg-0 btn btn-actions ml-0 ml-lg-2 marginleft marginbottom1">Move to Unconfirmed</button>
    ...
    <div class="popup" id="deletepopup">
        ...
        <div class="content">
            ...
            <div class="center">
                ...
                <label>Are you sure about deleting these records? Has the booker's stay passed?</label>
    ...
    <div class="popup" id="movepopup">
        ...
        <div class="content">
            ...
            <div class="center">
                <img src="../image/warning-orange.png" style="max-height: 180px; max-width: 180px;">
                <label>Are you sure about moving these records back to unconfirmed? This will send an email to the booker that you made a mistake.</label>
